...
export default class SalesPerHour extends Component {
  ...
  fetchGraphData = () => {
    ...
    ApiService.get_sales_per_hour(date,businessId).then(res => {
      if(res.status === 200) {
       ...
       <div>
        <Row className="sph">
          <Col lg={6} md={6} xs={12} className="responsive">
           <span className="title-text">Sales per hour</span>
          </Col>
