...
export default class TicketSellFee extends Component {
  ...
  formSubmit = (e) => {
    ...
    if(ask) {
      ...
      ApiService.ticket_fee(amount, discounttype)
      .then(res => {
        if(res.status == 200) {
    ...
    return (
      <div>
        ...
        <form onSubmit={this.formSubmit}>
          <div>
            <label style={{ marginBottom: -15, color: 'green', marginTop: 10, fontSize: 16 }}>Ticket sale fee</label><br></br>
