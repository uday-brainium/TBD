...
export default class ReservationUpChargeFee extends Component {
  ...
  formSubmit = (e) => {
    ...
    if(ask) {
      ...
      ApiService.reservation_up_fee(amount, discounttype)
      .then(res => {
        if(res.status == 200) {
    ...
    return (
      <div>
        ...
        <form onSubmit={this.formSubmit}>
          <div>
            <label style={{ marginBottom: -15, color: 'green', marginTop: 10, fontSize: 16 }}>Fee for more that 100 reservation/month</label><br></br>
